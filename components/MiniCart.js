            ...
            >
              <div className="w-screen max-w-md">
                <div className="flex flex-col h-full overflow-y-scroll bg-white shadow-xl">
                  <div className="flex-1 px-4 py-6 overflow-y-auto sm:px-6 bg-black text-white">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center ml-3 h-7">
                        <button
                          ref={cancelButtonRef}
                          type="button"
                          className="p-2 -m-2 text-white hover:text-gray-500"
                            ...
                            {cart.map((product) => (
                              ...
                              >
                                ...
                                <div className="flex flex-col flex-1 ml-4">
                                  <div>
                                    <div className="flex justify-between text-base font-medium text-white hover:text-red-500">
                                      <h3>
                                        <Link
                                  ...
                                  <div className="flex items-end justify-between flex-1 text-sm text-red-500">
                  ...
                  {cart.length > 0 ? (
                    <div className="px-4 py-6 border-t border-gray-200 sm:px-6 bg-black text-white">
                      ...
                      <div className="mt-6">
                        <a
                          ...
                          className={`flex items-center text-white justify-center px-6 py-3 text-base font-medium border border-transparent rounded-md shadow-sm hover:bg-red-500 ${
                            cartLoading
                              ? "cursor-not-allowed"
                              : "cursor-pointer"
                          }`}
